# Chương 3 — Khảo sát công trình liên quan

## 3.1. Phân nhóm tổng quan
...
### 3.3.4. DiverseVul [@chen2023diversevul]

- Dataset C/C++ ~ 18K vuln; bổ sung diversity (nhiều repo).
- Cho thấy model train trên 1 repo không generalize tốt sang repo khác.

## 3.4. LLM-based vulnerability detection

### 3.4.1. Khảo sát baseline — Khare et al. 2024 [@khare2024understanding]
...
### 3.4.6. SeCoRA, VulnDetect, GPTLens [@li2023gptlens]
...
### 3.4.7. Tổng kết khoảng trống (research gap)
...
## 3.5. Bộ dữ liệu & benchmark hiện có
...
## 3.6. Công cụ thương mại liên quan
...
## 3.7. Định vị CobA so với công trình liên quan
...
## 3.8. Khoảng trống mà CobA giải quyết
