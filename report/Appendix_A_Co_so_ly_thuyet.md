# Phụ lục A — Cơ sở lý thuyết

> Phần này nguyên là Chương 2 trong bản 7-chương; được đưa xuống phụ lục theo định dạng khoá luận 3 chương.

## A.1. Lỗ hổng an toàn mã nguồn
...
### A.1.2. Phân loại theo CWE và OWASP
...
### A.1.3. Các họ lỗ hổng quan tâm trong CobA
...
### A.1.4. Mô hình tấn công cơ bản — Taint analysis
...
## A.2. Phân tích chương trình tĩnh

### A.2.1. AST — Abstract Syntax Tree
...
### A.2.3. PDG — Program Dependence Graph
...
### A.2.5. SAST — Static Application Security Testing
...
## A.3. Mô hình ngôn ngữ lớn (LLM)

### A.3.1. Transformer & Decoder-only
...
### A.3.6. Khả năng & hạn chế của LLM
...
## A.4. Retrieval-Augmented Generation (RAG)
...
### A.4.4. RAG cho phát hiện lỗ hổng
...
## A.5. Code chunking & multi-file reasoning

### A.5.1. Vì sao cần chunking
...
## A.6. Đánh giá hiệu năng

### A.6.1. Confusion matrix
...
## A.7. Anti-hallucination cho LLM

### A.7.1. Tổng quan biện pháp
...
### A.7.2. Confirmation bias trong Verifier
